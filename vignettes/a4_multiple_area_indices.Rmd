...
```{r filter-config, eval=TRUE, echo=TRUE}
...
```{r print-config, eval=TRUE, echo=TRUE}
...
```{r config-formula, eval=TRUE, echo=TRUE}
...
```{r print-check, eval=TRUE, echo=TRUE}
dplyr::filter(data) |>
...
```{r na-check, eval=TRUE, echo=TRUE}
...
```{r map-settings, eval=TRUE, echo=TRUE}
map_pres <- coef_names
...
```{r start-settings, eval=TRUE, echo=TRUE}
